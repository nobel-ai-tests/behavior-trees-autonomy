...
<!-- Abstract reproduced verbatim from the CC BY 4.0 arXiv preprint, aligned to the accepted/published version. -->
...
This paper bridges high-level BT task logic and contact-rich manipulation. It also provides a concrete BehaviorTree.CPP-oriented example with asynchronous actions, reactive control-flow nodes, and blackboard data.
